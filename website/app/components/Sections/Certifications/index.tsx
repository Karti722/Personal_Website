...
// Keep in sync with the number of .certification cards rendered below.
export const CERT_COUNT = 4;
      ...
      <div className="container">
        ...
        <Reveal delay={0}>
          <div className={styles.certification}>
            <h3>
              PACR Internship Certificate of Completion
        ...
        <Reveal delay={140}>
          <div className={styles.certification}>
            <h3>
              SkyIT Internship Certificate of Completion
              <PixelSparkle className={styles.statusBadge}>
                <HudBadge tone="success">Verified</HudBadge>
              </PixelSparkle>
            </h3>
